# category-featured-last Specification

## Purpose
Controls layout behavior for the last category card in `CategoryShowcase`. The last card spans the full grid width with a horizontal layout and constrained image, creating visual hierarchy on tablet+ screens.
