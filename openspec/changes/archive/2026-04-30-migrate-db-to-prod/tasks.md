...
- [x] Create `backend/scripts/` directory. <!-- id: 0 -->
- [x] Create `backend/scripts/migrate_db.sh` with environment loading logic. <!-- id: 1 -->
- [x] Add `*.bak` and `*.sql` to `backend/.gitignore`. <!-- id: 2 -->
...
- [x] Add logic to sync `backend/media/` to production (S3 or remote path). <!-- id: 12 -->
