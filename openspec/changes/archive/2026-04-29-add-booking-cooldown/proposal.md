...
## What Changes
- **Dashboard Models:** Add `booking_cooldown_minutes` to the `CompanyProfile` model (managed via Django Admin).
...
## Impact
- **Affected Specs:** `availability-logic`, `dashboard-models`.
- **Affected Code:** `dashboard/booking/models.py`, `dashboard/booking/serializers.py`, `dashboard/utils/availability.py`.
