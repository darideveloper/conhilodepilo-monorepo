...
## Summary
To improve developer productivity by providing a single, consistent entry point to start the backend and frontend subprojects simultaneously using `tmux`.
...
- Configure the script to manage `backend`, `booking`, and `landing` services.
