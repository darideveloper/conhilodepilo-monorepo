...
## Summary
Transition the current reactive, client-side, local-state-based availability system (which uses intersection logic and virtual date injection) to a server-side API-driven model. This will ensure availability data is accurate, real-time, and consistent with the dashboard.
...
- **Goal:** The application MUST display accurate availability data from the dashboard.

## Impact
- Improved data integrity.
- Reduction in client-side code complexity.
- Requires dashboard endpoint availability.
